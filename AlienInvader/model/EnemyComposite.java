...
public class EnemyComposite extends GameElement {
	...
	public static final int UNIT_MOVE = 3; // speed
	...
	public void processCollision(PlayerShip shooter) {
		...
		for (var row : rows) {
			...
			AlienBoard.enemies -= removeEnemies.size();
			removeEnemies.clear();
			removeBullets.clear();
			...
			if (AlienBoard.enemies == 0) {
				...
				gameboard.getCanvas().getGameElements().add(new TextDraw("RETURN", 610, 455, Color.RED, 15));
				gameboard.getScoreCard().setText("Score: " + AlienBoard.score);
				AlienBoard.score = 0;
			}
		}
		...
		for (var row : rows) {
			...
			// gameboard.getCanvas().getGameElements().clear();
			// gameboard.getCanvas().getGameElements().add(new TextDraw("YOU WIN!", 73, 150,
			// Color.GREEN, 100));
			// gameboard.getCanvas().getGameElements().add(new TextDraw("EXIT", 605, 450,
			// Color.RED, 35));
			// gameboard.getScoreCard().setText("Score: " + AlienBoard.score);
			// AlienBoard.score = 0;
			// }
