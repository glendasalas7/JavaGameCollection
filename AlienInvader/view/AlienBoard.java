...
public class AlienBoard {
	...
	public void init() {
		...
		canvas.getGameElements().add(new TextDraw("SPACE INVADER", 55, 125, Color.GREEN, 70));
		canvas.getGameElements().add(new TextDraw("Click <Start> to play", 240, 190, Color.MAGENTA, 20));
